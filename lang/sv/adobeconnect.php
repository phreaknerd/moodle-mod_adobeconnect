...
$string['adobeconnecthost'] = 'Mötesvärd ';
...
$string['adobeconnectintro'] = 'Om';
$string['adobeconnectname'] = 'Titel på mötet';
$string['adobeconnectparticipant'] = 'Deltagare';
$string['adobeconnectparticipantdescription'] = 'Can view, but cannot modify any of the meeting settings';
$string['adobeconnectpresenter'] = 'Deltagare';
...
$string['selectparticipants'] = 'Tilldela roller';
$string['starttime'] = 'Startar';
...
$string['meetinfo'] = 'Detaljerad information';
$string['meetinfotxt'] = 'Detaljer om mötet';
